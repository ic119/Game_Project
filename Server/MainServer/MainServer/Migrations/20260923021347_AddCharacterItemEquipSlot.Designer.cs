...
namespace MainServer.Migrations
{
    ...
    [Migration("20260923021347_AddCharacterItemEquipSlot")]
    partial class AddCharacterItemEquipSlot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MainServer.CharacterServer.Entities.CharacterItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CharacterId", "EquipSlot")
                        .IsUnique();
            ...
            modelBuilder.Entity("MainServer.CharacterServer.Entities.CharacterItem", b =>
                {
                    b.HasOne("MainServer.CharacterServer.Entities.Character", "Character")
                        .WithMany()
